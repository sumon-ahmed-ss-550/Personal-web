...
export default function About() {
  return (
    <section className="py-20 md:py-32 bg-brand-dark overflow-hidden" id="about">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full md:w-[60%] flex flex-col gap-4 md:gap-6 items-start">
              {[
                ...
                { label: 'Location', value: 'Rangpur, Bangladesh', icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z' },
                { label: 'Experience', value: '2+ Years', icon: 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
              ].map((card, i) => (
                <motion.div
                  key={i}
                ...
                >
                  ...
                  <div className="flex flex-col justify-center overflow-hidden min-w-0 flex-1">
                    <p className="text-[10px] text-brand-primary font-black uppercase tracking-widest mb-0.5">{card.label}</p>
